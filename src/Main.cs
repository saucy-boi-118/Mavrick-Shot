...
namespace Main
{
    ...
    class Program
    {
        ...
        public static void Main()
        {
            ...
            // Enemy 
            Texture2D enemyTexture = LoadTextureOutsideDirectory("assets/Enemy.png");
            Rectangle ESource = GenerateSource(enemyTexture);
            Rectangle EDest = GenerateDest(enemyTexture, 7);
            ...
            while (!Raylib.WindowShouldClose())
            {
                ...
                else
                {
                    ...
                    // updating enemies
                    e.UpdateEnemies(enemyTexture, ESource, EDest, EOrigin, p.Position, dt);
